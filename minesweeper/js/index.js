...
console.log(`
Пояснение, для удобства проверки:
-таймер показывает время до проигрыша с возможностью настройки, затраченное время записывается в результаты;
-количество бомб вынесено в настройки, для возможности изменения;
-что бы интереснее было играть режим Easy ограничен 30 бомбами, режим Medium - 99, режим Hards - 200;
-изменения количества времени/бомб в настройках, сохраняются автоматически;
-если игра активна, то последний режим сохраняется автоматически, до последующей загрузки страницы;
`);
